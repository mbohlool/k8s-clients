...
from k8sclient.apis.v1beta1_storage_api import V1beta1StorageApi


class TestV1beta1StorageApi(unittest.TestCase):
    """ V1beta1StorageApi unit test stubs """

    def setUp(self):
        self.api = k8sclient.apis.v1beta1_storage_api.V1beta1StorageApi()
