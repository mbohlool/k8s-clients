...
from k8sclient.apis.v1_core_api import V1CoreApi


class TestV1CoreApi(unittest.TestCase):
    """ V1CoreApi unit test stubs """

    def setUp(self):
        self.api = k8sclient.apis.v1_core_api.V1CoreApi()
