# k8sclient.V2alpha1BatchApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_api_resources**](V2alpha1BatchApi.md#get_api_resources) | **GET** /apis/batch/v2alpha1/ | 
...
try: 
    ...
    print("Exception when calling V2alpha1BatchApi->get_api_resources: %s\n" % e)
```
