# k8sclient.V1beta1AuthorizationApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_namespaced_local_subject_access_review**](V1beta1AuthorizationApi.md#create_namespaced_local_subject_access_review) | **POST** /apis/authorization.k8s.io/v1beta1/namespaces/{namespace}/localsubjectaccessreviews | 
[**create_self_subject_access_review**](V1beta1AuthorizationApi.md#create_self_subject_access_review) | **POST** /apis/authorization.k8s.io/v1beta1/selfsubjectaccessreviews | 
[**create_subject_access_review**](V1beta1AuthorizationApi.md#create_subject_access_review) | **POST** /apis/authorization.k8s.io/v1beta1/subjectaccessreviews | 
[**get_api_resources**](V1beta1AuthorizationApi.md#get_api_resources) | **GET** /apis/authorization.k8s.io/v1beta1/ | 
...
try: 
    ...
    print("Exception when calling V1beta1AuthorizationApi->create_namespaced_local_subject_access_review: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1AuthorizationApi->create_self_subject_access_review: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1AuthorizationApi->create_subject_access_review: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1AuthorizationApi->get_api_resources: %s\n" % e)
```
