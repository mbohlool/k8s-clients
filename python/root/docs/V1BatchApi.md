...
------------- | ------------- | -------------
[**create_namespaced_job**](V1BatchApi.md#create_namespaced_job) | **POST** /apis/batch/v1/namespaces/{namespace}/jobs | 
[**delete_collection_namespaced_job**](V1BatchApi.md#delete_collection_namespaced_job) | **DELETE** /apis/batch/v1/namespaces/{namespace}/jobs | 
[**delete_namespaced_job**](V1BatchApi.md#delete_namespaced_job) | **DELETE** /apis/batch/v1/namespaces/{namespace}/jobs/{name} | 
[**get_api_resources**](V1BatchApi.md#get_api_resources) | **GET** /apis/batch/v1/ | 
[**list_job_for_all_namespaces**](V1BatchApi.md#list_job_for_all_namespaces) | **GET** /apis/batch/v1/jobs | 
[**list_namespaced_job**](V1BatchApi.md#list_namespaced_job) | **GET** /apis/batch/v1/namespaces/{namespace}/jobs | 
[**patch_namespaced_job**](V1BatchApi.md#patch_namespaced_job) | **PATCH** /apis/batch/v1/namespaces/{namespace}/jobs/{name} | 
[**patch_namespaced_job_status**](V1BatchApi.md#patch_namespaced_job_status) | **PATCH** /apis/batch/v1/namespaces/{namespace}/jobs/{name}/status | 
[**read_namespaced_job**](V1BatchApi.md#read_namespaced_job) | **GET** /apis/batch/v1/namespaces/{namespace}/jobs/{name} | 
[**read_namespaced_job_status**](V1BatchApi.md#read_namespaced_job_status) | **GET** /apis/batch/v1/namespaces/{namespace}/jobs/{name}/status | 
[**replace_namespaced_job**](V1BatchApi.md#replace_namespaced_job) | **PUT** /apis/batch/v1/namespaces/{namespace}/jobs/{name} | 
[**replace_namespaced_job_status**](V1BatchApi.md#replace_namespaced_job_status) | **PUT** /apis/batch/v1/namespaces/{namespace}/jobs/{name}/status | 
[**watch_job_list_for_all_namespaces**](V1BatchApi.md#watch_job_list_for_all_namespaces) | **GET** /apis/batch/v1/watch/jobs | 
[**watch_namespaced_job**](V1BatchApi.md#watch_namespaced_job) | **GET** /apis/batch/v1/watch/namespaces/{namespace}/jobs/{name} | 
[**watch_namespaced_job_list**](V1BatchApi.md#watch_namespaced_job_list) | **GET** /apis/batch/v1/watch/namespaces/{namespace}/jobs | 
...
try: 
    ...
    print("Exception when calling V1BatchApi->create_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->delete_collection_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->delete_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->get_api_resources: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->list_job_for_all_namespaces: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->list_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->patch_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->patch_namespaced_job_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->read_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->read_namespaced_job_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->replace_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->replace_namespaced_job_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->watch_job_list_for_all_namespaces: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->watch_namespaced_job: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1BatchApi->watch_namespaced_job_list: %s\n" % e)
```
