...
------------- | ------------- | -------------
[**create_namespaced_pet_set**](V1alpha1AppsApi.md#create_namespaced_pet_set) | **POST** /apis/apps/v1alpha1/namespaces/{namespace}/petsets | 
[**delete_collection_namespaced_pet_set**](V1alpha1AppsApi.md#delete_collection_namespaced_pet_set) | **DELETE** /apis/apps/v1alpha1/namespaces/{namespace}/petsets | 
[**delete_namespaced_pet_set**](V1alpha1AppsApi.md#delete_namespaced_pet_set) | **DELETE** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**get_api_resources**](V1alpha1AppsApi.md#get_api_resources) | **GET** /apis/apps/v1alpha1/ | 
[**list_namespaced_pet_set**](V1alpha1AppsApi.md#list_namespaced_pet_set) | **GET** /apis/apps/v1alpha1/namespaces/{namespace}/petsets | 
[**list_pet_set_for_all_namespaces**](V1alpha1AppsApi.md#list_pet_set_for_all_namespaces) | **GET** /apis/apps/v1alpha1/petsets | 
[**patch_namespaced_pet_set**](V1alpha1AppsApi.md#patch_namespaced_pet_set) | **PATCH** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**patch_namespaced_pet_set_status**](V1alpha1AppsApi.md#patch_namespaced_pet_set_status) | **PATCH** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name}/status | 
[**read_namespaced_pet_set**](V1alpha1AppsApi.md#read_namespaced_pet_set) | **GET** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**read_namespaced_pet_set_status**](V1alpha1AppsApi.md#read_namespaced_pet_set_status) | **GET** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name}/status | 
[**replace_namespaced_pet_set**](V1alpha1AppsApi.md#replace_namespaced_pet_set) | **PUT** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**replace_namespaced_pet_set_status**](V1alpha1AppsApi.md#replace_namespaced_pet_set_status) | **PUT** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name}/status | 
[**watch_namespaced_pet_set**](V1alpha1AppsApi.md#watch_namespaced_pet_set) | **GET** /apis/apps/v1alpha1/watch/namespaces/{namespace}/petsets/{name} | 
[**watch_namespaced_pet_set_list**](V1alpha1AppsApi.md#watch_namespaced_pet_set_list) | **GET** /apis/apps/v1alpha1/watch/namespaces/{namespace}/petsets | 
[**watch_pet_set_list_for_all_namespaces**](V1alpha1AppsApi.md#watch_pet_set_list_for_all_namespaces) | **GET** /apis/apps/v1alpha1/watch/petsets | 
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->create_namespaced_pet_set: %s\n" % e)
```
...
# **delete_collection_namespaced_pet_set**
> UnversionedStatus delete_collection_namespaced_pet_set(namespace, pretty=pretty, field_selector=field_selector, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    api_response = api_instance.delete_collection_namespaced_pet_set(namespace, pretty=pretty, field_selector=field_selector, label_selector=label_selector, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling V1alpha1AppsApi->delete_collection_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->delete_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->get_api_resources: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->list_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->list_pet_set_for_all_namespaces: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->patch_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->patch_namespaced_pet_set_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->read_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->read_namespaced_pet_set_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->replace_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->replace_namespaced_pet_set_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->watch_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->watch_namespaced_pet_set_list: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1AppsApi->watch_pet_set_list_for_all_namespaces: %s\n" % e)
```
