...
class DefaultApi(object):
    ...
    def deletecollection_namespaced_pet_set(self, namespace, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.deletecollection_namespaced_pet_set_with_http_info(namespace, **kwargs)
        else:
            (data) = self.deletecollection_namespaced_pet_set_with_http_info(namespace, **kwargs)
            return data

    def deletecollection_namespaced_pet_set_with_http_info(self, namespace, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.deletecollection_namespaced_pet_set_with_http_info(namespace, callback=callback_function)
