...
from k8sclient.apis.v1alpha1_rbac_authorization_api import V1alpha1RbacAuthorizationApi


class TestV1alpha1RbacAuthorizationApi(unittest.TestCase):
    """ V1alpha1RbacAuthorizationApi unit test stubs """

    def setUp(self):
        self.api = k8sclient.apis.v1alpha1_rbac_authorization_api.V1alpha1RbacAuthorizationApi()
