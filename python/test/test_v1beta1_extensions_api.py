...
from k8sclient.apis.v1beta1_extensions_api import V1beta1ExtensionsApi


class TestV1beta1ExtensionsApi(unittest.TestCase):
    """ V1beta1ExtensionsApi unit test stubs """

    def setUp(self):
        self.api = k8sclient.apis.v1beta1_extensions_api.V1beta1ExtensionsApi()
