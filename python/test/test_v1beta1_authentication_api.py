...
from k8sclient.apis.v1beta1_authentication_api import V1beta1AuthenticationApi


class TestV1beta1AuthenticationApi(unittest.TestCase):
    """ V1beta1AuthenticationApi unit test stubs """

    def setUp(self):
        self.api = k8sclient.apis.v1beta1_authentication_api.V1beta1AuthenticationApi()
