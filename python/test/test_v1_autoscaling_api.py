...
from k8sclient.apis.v1_autoscaling_api import V1AutoscalingApi


class TestV1AutoscalingApi(unittest.TestCase):
    """ V1AutoscalingApi unit test stubs """

    def setUp(self):
        self.api = k8sclient.apis.v1_autoscaling_api.V1AutoscalingApi()
