...
------------- | ------------- | -------------
[**create_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#create_certificates_v1alpha1_certificate_signing_request) | **POST** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests | 
[**delete_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#delete_certificates_v1alpha1_certificate_signing_request) | **DELETE** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name} | 
[**delete_certificates_v1alpha1_collection_certificate_signing_request**](V1alpha1CertificatesApi.md#delete_certificates_v1alpha1_collection_certificate_signing_request) | **DELETE** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests | 
[**get_certificates_v1alpha1_api_resources**](V1alpha1CertificatesApi.md#get_certificates_v1alpha1_api_resources) | **GET** /apis/certificates.k8s.io/v1alpha1/ | 
[**list_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#list_certificates_v1alpha1_certificate_signing_request) | **GET** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests | 
[**patch_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#patch_certificates_v1alpha1_certificate_signing_request) | **PATCH** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name} | 
[**read_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#read_certificates_v1alpha1_certificate_signing_request) | **GET** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name} | 
[**replace_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#replace_certificates_v1alpha1_certificate_signing_request) | **PUT** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name} | 
[**replace_certificates_v1alpha1_certificate_signing_request_approval**](V1alpha1CertificatesApi.md#replace_certificates_v1alpha1_certificate_signing_request_approval) | **PUT** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name}/approval | 
[**replace_certificates_v1alpha1_certificate_signing_request_status**](V1alpha1CertificatesApi.md#replace_certificates_v1alpha1_certificate_signing_request_status) | **PUT** /apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name}/status | 
[**watch_certificates_v1alpha1_certificate_signing_request**](V1alpha1CertificatesApi.md#watch_certificates_v1alpha1_certificate_signing_request) | **GET** /apis/certificates.k8s.io/v1alpha1/watch/certificatesigningrequests/{name} | 
[**watch_certificates_v1alpha1_certificate_signing_request_list**](V1alpha1CertificatesApi.md#watch_certificates_v1alpha1_certificate_signing_request_list) | **GET** /apis/certificates.k8s.io/v1alpha1/watch/certificatesigningrequests | 
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->create_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->delete_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->delete_certificates_v1alpha1_collection_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->get_certificates_v1alpha1_api_resources: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->list_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->patch_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->read_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->replace_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->replace_certificates_v1alpha1_certificate_signing_request_approval: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->replace_certificates_v1alpha1_certificate_signing_request_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->watch_certificates_v1alpha1_certificate_signing_request: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1alpha1CertificatesApi->watch_certificates_v1alpha1_certificate_signing_request_list: %s\n" % e)
```
