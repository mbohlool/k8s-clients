# k8sclient.V1beta1StorageApi

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_storage_v1beta1_storage_class**](V1beta1StorageApi.md#create_storage_v1beta1_storage_class) | **POST** /apis/storage.k8s.io/v1beta1/storageclasses | 
[**delete_storage_v1beta1_collection_storage_class**](V1beta1StorageApi.md#delete_storage_v1beta1_collection_storage_class) | **DELETE** /apis/storage.k8s.io/v1beta1/storageclasses | 
[**delete_storage_v1beta1_storage_class**](V1beta1StorageApi.md#delete_storage_v1beta1_storage_class) | **DELETE** /apis/storage.k8s.io/v1beta1/storageclasses/{name} | 
[**get_storage_v1beta1_api_resources**](V1beta1StorageApi.md#get_storage_v1beta1_api_resources) | **GET** /apis/storage.k8s.io/v1beta1/ | 
[**list_storage_v1beta1_storage_class**](V1beta1StorageApi.md#list_storage_v1beta1_storage_class) | **GET** /apis/storage.k8s.io/v1beta1/storageclasses | 
[**patch_storage_v1beta1_storage_class**](V1beta1StorageApi.md#patch_storage_v1beta1_storage_class) | **PATCH** /apis/storage.k8s.io/v1beta1/storageclasses/{name} | 
[**read_storage_v1beta1_storage_class**](V1beta1StorageApi.md#read_storage_v1beta1_storage_class) | **GET** /apis/storage.k8s.io/v1beta1/storageclasses/{name} | 
[**replace_storage_v1beta1_storage_class**](V1beta1StorageApi.md#replace_storage_v1beta1_storage_class) | **PUT** /apis/storage.k8s.io/v1beta1/storageclasses/{name} | 
[**watch_storage_v1beta1_storage_class**](V1beta1StorageApi.md#watch_storage_v1beta1_storage_class) | **GET** /apis/storage.k8s.io/v1beta1/watch/storageclasses/{name} | 
[**watch_storage_v1beta1_storage_class_list**](V1beta1StorageApi.md#watch_storage_v1beta1_storage_class_list) | **GET** /apis/storage.k8s.io/v1beta1/watch/storageclasses | 
...
api_instance = k8sclient.V1beta1StorageApi()
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->create_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->delete_storage_v1beta1_collection_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->delete_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->get_storage_v1beta1_api_resources: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->list_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->patch_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->read_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->replace_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->watch_storage_v1beta1_storage_class: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling V1beta1StorageApi->watch_storage_v1beta1_storage_class_list: %s\n" % e)
```
