...
------------- | ------------- | -------------
[**create_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#create_apps_v1alpha1_namespaced_pet_set) | **POST** /apis/apps/v1alpha1/namespaces/{namespace}/petsets | 
[**delete_apps_v1alpha1_collection_namespaced_pet_set**](AppsV1alpha1Api.md#delete_apps_v1alpha1_collection_namespaced_pet_set) | **DELETE** /apis/apps/v1alpha1/namespaces/{namespace}/petsets | 
[**delete_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#delete_apps_v1alpha1_namespaced_pet_set) | **DELETE** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**get_apps_v1alpha1_api_resources**](AppsV1alpha1Api.md#get_apps_v1alpha1_api_resources) | **GET** /apis/apps/v1alpha1/ | 
[**list_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#list_apps_v1alpha1_namespaced_pet_set) | **GET** /apis/apps/v1alpha1/namespaces/{namespace}/petsets | 
[**list_apps_v1alpha1_pet_set_for_all_namespaces**](AppsV1alpha1Api.md#list_apps_v1alpha1_pet_set_for_all_namespaces) | **GET** /apis/apps/v1alpha1/petsets | 
[**patch_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#patch_apps_v1alpha1_namespaced_pet_set) | **PATCH** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**patch_apps_v1alpha1_namespaced_pet_set_status**](AppsV1alpha1Api.md#patch_apps_v1alpha1_namespaced_pet_set_status) | **PATCH** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name}/status | 
[**read_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#read_apps_v1alpha1_namespaced_pet_set) | **GET** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**read_apps_v1alpha1_namespaced_pet_set_status**](AppsV1alpha1Api.md#read_apps_v1alpha1_namespaced_pet_set_status) | **GET** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name}/status | 
[**replace_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#replace_apps_v1alpha1_namespaced_pet_set) | **PUT** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name} | 
[**replace_apps_v1alpha1_namespaced_pet_set_status**](AppsV1alpha1Api.md#replace_apps_v1alpha1_namespaced_pet_set_status) | **PUT** /apis/apps/v1alpha1/namespaces/{namespace}/petsets/{name}/status | 
[**watch_apps_v1alpha1_namespaced_pet_set**](AppsV1alpha1Api.md#watch_apps_v1alpha1_namespaced_pet_set) | **GET** /apis/apps/v1alpha1/watch/namespaces/{namespace}/petsets/{name} | 
[**watch_apps_v1alpha1_namespaced_pet_set_list**](AppsV1alpha1Api.md#watch_apps_v1alpha1_namespaced_pet_set_list) | **GET** /apis/apps/v1alpha1/watch/namespaces/{namespace}/petsets | 
[**watch_apps_v1alpha1_pet_set_list_for_all_namespaces**](AppsV1alpha1Api.md#watch_apps_v1alpha1_pet_set_list_for_all_namespaces) | **GET** /apis/apps/v1alpha1/watch/petsets | 
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->create_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->delete_apps_v1alpha1_collection_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->delete_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->list_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->list_apps_v1alpha1_pet_set_for_all_namespaces: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->patch_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->patch_apps_v1alpha1_namespaced_pet_set_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->read_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->read_apps_v1alpha1_namespaced_pet_set_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->replace_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->replace_apps_v1alpha1_namespaced_pet_set_status: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->watch_apps_v1alpha1_namespaced_pet_set: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->watch_apps_v1alpha1_namespaced_pet_set_list: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling AppsV1alpha1Api->watch_apps_v1alpha1_pet_set_list_for_all_namespaces: %s\n" % e)
```
